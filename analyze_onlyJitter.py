...
infile = './WDS04342/chain_100000_gammas.txt'
...
texout = './WDS04342/chain_100000_gammas.tex'
...
def plot_foldedRV(p, t, rv, rvErr, figname):
    '''
    ...
    plt.savefig(foldername + figname)
    plt.show()
