...
labels = ['$P$ (days)', '$t_{tran}$ (days)', '$K_1$ (km/s)']
...
infile = './HD102509/chain_100000_FixedEcc.txt'
...
texout = './HD102509/chain_100000_FixedEcc.tex'

foldername = './HD102509/'
RVfigname_meds = 'RVfit_meds_100000_FixedEcc.jpg'
RVfigname_best = 'RVfit_best_100000_FixedEcc.jpg'
cornerFigname = 'corner_100000_FixedEcc.jpg'
chainFigname = 'chainPlot_100000_FixedEcc.jpg'
...
def plot_RV(p, t, rv,rvErr):
    ...
    model = RV_model(t_plot, period, ttran, K, gammas[0])
    ax0.plot(t_plot, model, color = 'k')


    rv_models = []
    for ii in range(0, len(t)):
        rv_models.append(RV_model(t[ii], period, ttran, K, gammas[0]))
...
def plot_foldedRV(p, t, rv, rvErr, filename):
    ...
    model = RV_model(tMod, period, ttran, K, gammas[0])
...
def get_RMS_residuals(p, t, rv, rvErr):
    ...
    rv_models = []
    for ii in range(0, len(t)):
        rv_models.append(RV_model(t[ii], period, ttran, K, gammas[ii]))
